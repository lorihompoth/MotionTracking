...
class Gui:
    ...
    def startButtonClicked(self):
        ...
        self.__fontScale = self.spinBox1.value()
        ...
        self.__blur = self.lineEdit2.text()
        self.__threshold = self.lineEdit3.text()
        self.__standbyBetweenMovements = self.lineEdit4.text()
        self.__cameraFieldOfView = self.lineEdit5.text()
        self.__minTrigger = self.lineEdit6.text()
